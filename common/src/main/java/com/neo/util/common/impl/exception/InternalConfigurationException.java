...
public class InternalConfigurationException extends IllegalStateException {
    ...
    /**
     * Constructs a new InternalConfigurationException with the specified detail message.  The
    ...
    /**
     * Constructs a new InternalConfigurationException with the specified detail message and
    ...
    /**
     * Constructs a new InternalConfigurationException with the specified cause and a detail
