package com.neo.util.jakarta.json;
...
public class JsonSchemaLoader {
    ...
    @Inject
    public JsonSchemaLoader(ConfigService configService, ReflectionProvider reflectionService) {
        ...
        for (String filePath: reflectionService.getResources("^configuration/schema.*\\.json$")) {
            addSchema(mapToFill, JSON_SCHEMA_LOCATION,
                    filePath.substring(JSON_SCHEMA_LOCATION.length()));
        }
