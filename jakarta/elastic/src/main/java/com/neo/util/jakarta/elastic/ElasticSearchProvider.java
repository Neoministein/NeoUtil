...
import com.neo.util.jakarta.elastic.aggregation.BucketScriptAggregation;
...
public class ElasticSearchProvider implements SearchProvider {
    ...
    protected Aggregation buildAggregation(SearchAggregation aggregation) {
        return switch (aggregation) {
            ...
            case com.neo.util.jakarta.elastic.aggregation.BucketScriptAggregation bucketScriptAggregation -> buildAggregation(bucketScriptAggregation);
    ...
    public List<String> getIndicesOfSearchable(Class<? extends Searchable> searchableClazz) {
