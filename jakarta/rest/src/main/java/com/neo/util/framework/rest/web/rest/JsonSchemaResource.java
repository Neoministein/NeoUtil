...
public class JsonSchemaResource {
    ...
    public static final ExceptionDetails EX_SCHEMA_DOES_NOT_EXIST = new ExceptionDetails("common/json/schema/invalid-path",
    ...
    public String getSchema(@PathParam("path") String path) {
        return jsonSchemaLoader.getJsonSchema(path)
