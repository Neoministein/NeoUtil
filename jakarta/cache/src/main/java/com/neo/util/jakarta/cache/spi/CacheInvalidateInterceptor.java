...
import com.neo.util.jakarta.cache.CacheException;
...
public class CacheInvalidateInterceptor extends CacheInterceptor {
    ...
    @Inject
    public CacheInvalidateInterceptor(CacheManager cacheManager, CacheKeyGeneratorManager cacheKeyGeneratorManager) {
